...
export default function Home() {
  ...
  return (
    <div className='bg-gradient-to-t from-sky-800 to-gray-800	h-screen overflow-x-auto	'>
      <header className=''>
        <nav className='px-4'>
      ...
      <section>
        <div className='text-center'>
          <h3 className='text-xl text-yellow-400 font-semibold'>Hello,</h3>
          <h1 className='text-3xl font-700 my-1 font-extrabold'>I am Popoy.</h1>
          <h1 className='text-xl font-semibold	text-green-300'>
            Fullstack Developer
          </h1>
          ...
          <div className='text-left px-4 py-4'>
            <h1 className='text-white text-2xl font-bold mb-4'>My Advantage</h1>
          ...
          <div className='bg-gradient-to-t from-yellow-900 to-gray-500 mt-8'>
            ...
            <div className='flex mx-4 mt-12 justify-between	'>
              <button className='px-8 bg-gray-900 hover:bg-gray-600 rounded-full py-2 mb-8 w-40'>Development</button>
              <button className='px-8 bg-gray-900 hover:bg-gray-600 rounded-full py-2 mb-8 w-40'>Marketing</button>
            </div>
          </div>
        </div>
      </section>
